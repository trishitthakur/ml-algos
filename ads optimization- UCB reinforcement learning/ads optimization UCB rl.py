...
for n in range(0, N):
    ...
    for i in range(0, d):
        ...
        if (numbers_of_selections[i] > 0):
            ...
            delta_i = math.sqrt(3/2 * math.log(n + 1) / numbers_of_selections[i]) # delta_i is confidence interval at round n
        ...
        if upper_bound > max_upper_bound:
            ...
            ad = i                           # select the ad with maximum sum of average_reward + delta_i
